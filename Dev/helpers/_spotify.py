...
async def parse_spotify(url: str, limit: int = 50) -> tuple[str | None, list[dict]]:
    """
    Spotify playlist/track/album link se song names nikaalta hai (no API key needed).
    Uses Spotify's public embed page.

    Returns: (kind, tracks) -> tracks = [{"name": str, "artists": str}, ...]
    """
