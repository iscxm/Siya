...
def _safe_btn(**kwargs) -> types.InlineKeyboardButton:
    ...
    Drops 'style' and 'icon_custom_emoji_id' if the current
    kurigram/pyrogram build does not support them."""
    try:
        ...
        try:
            ...
            # Last resort: keep only essential keys
    ...
    def help_markup(
        ...
        if back:
            ...
            cbs    = ["admins", "auth", "blist", "lang", "ping", "play",
                      "queue", "stats", "sudo", "Insta", "spotify", "playlist"]
